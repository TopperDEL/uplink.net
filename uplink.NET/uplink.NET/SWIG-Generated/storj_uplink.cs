...
p2=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp2);
  ...
  public static BucketRef open_bucket(ProjectRef p0, string p1, EncryptionAccess p2, out string p3) {
global::System.IntPtr tmpp3=global::System.IntPtr.Zero;
    try {
      BucketRef ret = new BucketRef(storj_uplinkPINVOKE.open_bucket(ProjectRef.getCPtr(p0), p1, EncryptionAccess.getCPtr(p2), ref tmpp3), true);
      if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
p3=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp3);
...
p1=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp1);
  ...
  public static MapRef new_map_ref() {
    MapRef ret = new MapRef(storj_uplinkPINVOKE.new_map_ref(), true);
    return ret;
  }

  public static void map_ref_set(MapRef p0, string p1, string p2, out string p3) {
global::System.IntPtr tmpp3=global::System.IntPtr.Zero;
    try {
      storj_uplinkPINVOKE.map_ref_set(MapRef.getCPtr(p0), p1, p2, ref tmpp3);
      if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
    } finally {
p3=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp3);
			  if(tmpp3 != System.IntPtr.Zero) storj_uplinkPINVOKE.free_string(tmpp3);
  ...
  public static string map_ref_get(MapRef p0, string p1, out string p2) {
global::System.IntPtr tmpp2=global::System.IntPtr.Zero;
    try {
      string ret = storj_uplinkPINVOKE.map_ref_get(MapRef.getCPtr(p0), p1, ref tmpp2);
      if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
p2=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp2);
  ...
  public static void map_ref_del(MapRef p0, string p1, out string p2) {
global::System.IntPtr tmpp2=global::System.IntPtr.Zero;
    try {
      storj_uplinkPINVOKE.map_ref_del(MapRef.getCPtr(p0), p1, ref tmpp2);
      if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
    } finally {
p2=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp2);
			  if(tmpp2 != System.IntPtr.Zero) storj_uplinkPINVOKE.free_string(tmpp2);
  ...
  public static void delete_map_ref(MapRef p0) {
    storj_uplinkPINVOKE.delete_map_ref(MapRef.getCPtr(p0));
    if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
  }
...
p3=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp3);
  ...
  public static int upload_write(UploaderRef p0, SWIGTYPE_p_uint8_t p1, int p2, out string p3) {
global::System.IntPtr tmpp3=global::System.IntPtr.Zero;
    try {
      int ret = storj_uplinkPINVOKE.upload_write(UploaderRef.getCPtr(p0), SWIGTYPE_p_uint8_t.getCPtr(p1), p2, ref tmpp3);
      if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
p3=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp3);
  ...
  public static void upload_close(UploaderRef p0, out string p1) {
global::System.IntPtr tmpp1=global::System.IntPtr.Zero;
    try {
      storj_uplinkPINVOKE.upload_close(UploaderRef.getCPtr(p0), ref tmpp1);
      if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
    } finally {
p1=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp1);
			  if(tmpp1 != System.IntPtr.Zero) storj_uplinkPINVOKE.free_string(tmpp1);
...
p2=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp2);
  ...
  public static int download_read(DownloaderRef p0, SWIGTYPE_p_uint8_t p1, int p2, out string p3) {
global::System.IntPtr tmpp3=global::System.IntPtr.Zero;
    try {
      int ret = storj_uplinkPINVOKE.download_read(DownloaderRef.getCPtr(p0), SWIGTYPE_p_uint8_t.getCPtr(p1), p2, ref tmpp3);
      if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
p3=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp3);
...
p1=global::System.Runtime.InteropServices.Marshal.PtrToStringAnsi(tmpp1);
  ...
  public static ProjectRef open_project(UplinkRef p0, string p1, APIKeyRef p2, ProjectOptions p3, out string p4) {
global::System.IntPtr tmpp4=global::System.IntPtr.Zero;
    try {
      ProjectRef ret = new ProjectRef(storj_uplinkPINVOKE.open_project(UplinkRef.getCPtr(p0), p1, APIKeyRef.getCPtr(p2), ProjectOptions.getCPtr(p3), ref tmpp4), true);
      if (storj_uplinkPINVOKE.SWIGPendingException.Pending) throw storj_uplinkPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    } finally {
