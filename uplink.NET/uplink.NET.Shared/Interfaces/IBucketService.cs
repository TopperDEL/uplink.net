...
namespace uplink.NET.Interfaces
{
    ...
    public interface IBucketService
    {
        ...
        Task<BucketInfo> CreateBucketAsync(Project project, string bucketName, BucketConfig bucketConfig);
        /// <summary>
        ...
        Task<BucketInfo> GetBucketInfoAsync(Project project, string bucketName);
        /// <summary>
        ...
        Task<BucketRef> OpenBucketAsync(Project project, string bucketName, EncryptionAccess encryptionAccess);
        /// <summary>
        ...
        Task<BucketList> ListBucketsAsync(Project project, BucketListOptions bucketListOptions);
        /// <summary>
        /// Delets a bucket together with it's possible content
        /// </summary>
        /// <param name="project">The handle to the current project</param>
        /// <param name="bucketName">The name of the bucket to delete</param>
        Task DeleteBucketAsync(Project project, string bucketName);
        /// <summary>
